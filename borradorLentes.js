...
//var src =  localStorage.getItem("glassesSrc")// document.getElementById("mi_imagen").src; //   // 'https://cloud.githubusercontent.com/assets/4652816/12771961/5341c3c4-ca68-11e5-844c-f659831d9c00.jpg';
src = GLASSES_SRC
...
function guardarImagenLentes(){
	...
	//localStorage.setItem("glassesSrc", image)
	GLASSES_SRC = image

console.log(document.querySelector(".component").style
.backgroundImage)
